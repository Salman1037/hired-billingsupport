        ...
        <div className="hero-inner">
          <div>
            ...
            <h1 className="display reveal reveal-2">
              Your practice should grow<em>without </em>
              <span className="underline-word">operational chaos</span>.
            </h1>
            ...
            <div className="hero-card">
              ...
              <div className="activity-feed">
                ...
                <div className="feed-row">
                  <span>Maya · Posted 34 payments (Aetna ERA)</span>
                  <span className="feed-tag">+ $8,420</span>
                </div>
                <div className="feed-row">
                  <span>Jordan · Resolved 6 denied claims</span>
                  <span className="feed-tag">+ $2,180</span>
                </div>
                <div className="feed-row">
                  <span>Sara · Verified eligibility for tomorrow's schedule</span>
                  <span className="feed-tag">28 patients</span>
                </div>
                <div className="feed-row">
                  <span>Ali · Obtained 4 prior auths (orthopedic)</span>
                  <span className="feed-tag">approved</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="block-head fade-in" style={{ textAlign: 'center', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            <h2 className="display">
              <span>The full </span><span>operational </span><em><span>stack</span></em><span>.</span>
            </h2>
            <p style={{ fontSize: '18px', lineHeight: '1.6', color: 'var(--ink-mute)', marginTop: '24px', maxWidth: '640px' }}>
              <span>Pick the layers you need. </span>
              <span>Run one service, </span>
              <span>or hand us the entire back office. </span>
              <span>Every engagement is shaped around your specialty, EHR, and growth stage.</span>
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'End-to-end ownership of your collections — coding, claim submission, AR follow-up, denials, payment posting, patient billing. One team, one accountable scorecard.',
                link: 'Explore RCM'
              },
              {
                icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10zM12 7v5l3 3',
                title: 'AR Recovery & Follow-Up',
                desc: 'We hunt aging claims — 30, 60, 90, 120+ days. Payer calls, status checks, resubmissions, appeals. Most clients see AR days drop below 30 within 90 days.',
                link: 'AR services'
              },
              {
                icon: 'M9 11l3 3 7-7M20 12v6a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h9',
                title: 'Medical Billing',
                desc: 'Specialty-trained coders and billers. CPT, ICD-10, HCPCS, modifier accuracy. Clean-claim submission as a discipline, not an afterthought.',
              ...
              },
              {
                ...
                desc: 'Pre-cert submission, payer follow-up, peer-to-peer prep. We shorten time-to-approval and stop the auth bottleneck from holding up patient care.',
                link: 'Prior auth'
              },
              {
                icon: 'M16 2v4M8 2v4M3 10h18M3 4h18v16a2 2 0 01-2 2H5a2 2 0 01-2-2V4a2 2 0 012-2h14a2 2 0 012 2v16',
                title: 'Insurance Verification',
                desc: 'Real-time eligibility and benefits checks before the patient walks in. Co-pays, deductibles, coverage limits — clarified, documented, in the chart.',
                link: 'Verification'
              },
              {
                icon: 'M20 7l-8 8-4-4M14 3h7v7M21 14v5a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h5',
                title: 'Virtual Medical Assistants',
                desc: 'Charting support, message triage, refill management, referrals, lab follow-up. A clinical extension of the provider — quiet, accurate, always there.',
                link: 'Virtual MAs'
              },
              {
                icon: 'M3 10h18M8 2v4M16 2v4M8 14h2M14 14h2M8 18h2M14 18h2M3 4h18v16a2 2 0 01-2 2H5a2 2 0 01-2-2V4a2 2 0 012-2h14a2 2 0 012 2v16',
                title: 'Front Desk Support',
                desc: 'Phones answered. Patients greeted (virtually). Schedules managed. We absorb the noise so your in-clinic team can focus on the patient in front of them.',
                link: 'Front desk'
              },
              {
                ...
                title: 'Healthcare Operations Mgmt',
                desc: 'For larger practices: an operations lead embedded in your team. Workflows, dashboards, KPIs, vendor management. The COO-layer you don\'t have yet.',
                link: 'Operations'
              }
            ].map((service, idx) => (
              <div key={idx} className="service-cell">
                ...
                <h4>{service.title}</h4>
                <p>{service.desc}</p>
                <a href="#" className="arrow-link">{service.link} <span className="arrow">→</span></a>
              </div>
            ))}
          </div>
        </div>
