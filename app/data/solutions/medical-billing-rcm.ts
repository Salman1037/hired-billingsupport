...
export const medicalBillingRcm: SolutionData = {
  ...
  subtitle: 'Your production looks fine on paper. Your collections tell a different story.',
  description: 'You are seeing patients. Charges are being entered. Claims are going out. And yet the money in the bank never quite matches the work you did this month. That gap is not accidental — and it is not unfixable. Hired Billing Support becomes your embedded medical billing and RCM team — working inside your EHR, following your workflow, and taking ownership of every step between eligibility and final payment.',
  hero: {
  ...
  sections: {
    pain: {
      ...
      ledger: [
        {
          num: '01',
          title: 'Eligibility errors that start at check-in',
          description: 'Coverage is verified too early, skipped under pressure, or never updated when a patient changes plans. The claim goes out against wrong or inactive insurance — and the denial arrives weeks later, long after anyone remembers what happened at registration.'
        },
        {
          num: '02',
          title: 'Prior authorizations tracked in too many places',
          description: 'Auth status lives in a spreadsheet, a sticky note, an EHR task, and someone\'s memory — simultaneously. When any one of those breaks down, the visit happens without a valid authorization. The claim gets denied. The appeal eats hours that should have gone somewhere else.'
        },
        {
          num: '03',
          title: 'Charge entry delayed after the visit',
          description: 'Charges entered two or three days after the appointment — with rushed coding, missing modifiers, or incorrectly linked diagnoses — add days to your payment cycle and create denial triggers that were entirely preventable.'
        },
        {
          num: '04',
          title: 'Denials not worked within a workable window',
          description: 'When a denial sits for three weeks before anyone reviews it, the appeal window is already shrinking. Many denials that should be reversed become permanent write-offs — not because they were wrong, but because follow-up was too slow.'
        },
        {
          num: '05',
          title: 'AR follow-up with no assigned ownership',
          description: 'Nobody is assigned to specific aging buckets. Nobody is measured on AR resolution. New claims always feel more urgent than old ones. So old claims keep aging until payers close the window — quietly, one claim at a time.'
        },
        {
          num: '06',
          title: 'Underpayments posted and never challenged',
          description: 'A payer sends $184 on a claim where the contracted rate is $248. Someone applies the payment and moves to the next item. Nobody checks the difference. Over a year, those small underpayments become a five-figure write-off the practice never agreed to.'
        },
        {
          num: '07',
          title: 'Payer-specific rules not followed consistently',
          description: 'Every payer has its own billing requirements — modifier policies, unit limits, documentation standards. When those rules are not reflected in the team\'s daily practice, correct claims keep failing for preventable reasons nobody has time to trace.'
        },
        {
          num: '08',
          title: 'No one owns the full arc of a single claim',
          description: 'Eligibility, coding, submission, follow-up, and payment posting are handled by different people with different priorities. Revenue falls in the handoffs. And since nobody has the complete picture, nobody can see the full scope of what is being lost.'
        }
      ]
    },
    solution: {
      ...
      process: [
        {
          ...
          description: 'Before touching a single claim, we understand how your practice bills today — your EHR, your payer mix, your team structure, and what your current AR and denial picture looks like. We diagnose first, then act.'
        },
        {
          num: '02',
          title: 'We work directly inside your EHR and PM system',
          description: 'We log in to your system. We work your queues. We post payments in your PM software. No file exports, no third-party portals, no workarounds — just your existing environment with our team working inside it.'
        },
        {
          num: '03',
          title: 'We follow your SOPs — and help improve them',
          description: 'We adapt to your existing workflows. Where we find gaps, we flag them, document the fix, and help you formalize a stronger process. Your billing operation becomes better documented and more consistent over time.'
        },
        {
          num: '04',
          title: 'We communicate inside your team\'s channels',
          description: 'Slack, Teams, EHR messaging, email — wherever your team already communicates, we show up there. Your staff does not reach out to a vendor. They communicate with a teammate who happens to work remotely.'
        },
        {
          num: '05',
          title: 'We scale without a new hiring cycle',
          description: 'New providers, new locations, seasonal volume changes — we scale immediately without a four-week job posting, without benefits overhead, and without the onboarding gaps that cost practices revenue every time they grow.'
        },
        {
          num: '06',
          title: 'We report, review, and improve on schedule',
          description: 'Performance reviews, denial trend analysis, AR aging reports — delivered to your leadership on a consistent schedule. Not reactive reports after something goes wrong. Proactive visibility so decisions get made before problems compound.'
        }
      ]
    },
    services: {
      ...
      items: [
        {
          ...
          description: 'Confirmed before every visit. Active coverage, deductibles, copays, and network status — verified against the actual payer, not a saved record from months ago.'
        },
        {
          num: '02',
          title: 'Prior Authorization Support',
          description: 'We track, request, follow up on, and document authorizations so a missing auth is never the reason a claim is denied.'
        },
        {
          num: '03',
        ...
        },
        {
          ...
          description: 'Every claim reviewed for errors, payer-specific rules, and missing data before submission — not after the denial comes back.'
        },
        {
          num: '05',
          title: 'Electronic Claims Submission',
          description: 'Formatted correctly for each payer, submitted promptly, and tracked from the moment it goes out.'
        },
        {
          num: '06',
          title: 'Denial Management',
          description: 'Every denial reviewed, categorized, and worked within a defined window. No denial sits idle while the timely filing clock runs.'
        },
        {
          num: '07',
        ...
        },
        {
          ...
          description: 'Regular reports on collection rates, denial trends, AR aging, and clean claim rates — with commentary and context, not just numbers.'
        }
      ]
    },
    aiHuman: {
      ...
      outcomes: [
        {
          ...
          description: 'Fewer rejections, fewer preventable denials, faster adjudication from payers who receive complete claims every time.'
        },
        {
          icon: '↓',
          title: 'Denial rates that trend downward',
          description: 'Root cause analysis on every denial category so the same mistakes stop repeating each month.'
        },
        {
          icon: '✓',
          title: 'AR aging that actually gets worked',
          description: 'Aging buckets assigned, prioritized, and touched regularly — before payers close the collection window.'
        },
        {
          icon: '$',
        ...
        },
        {
          ...
          description: 'Cleaner submissions plus faster follow-up equals shorter days in AR and more predictable monthly cash flow.'
        },
        {
          icon: '◎',
          title: 'Visibility leadership can act on',
