...
export const arManagement: SolutionData = {
  ...
  hero: {
    eyebrow: 'AR management & cash flow',
    title: 'The money is in your AR.<br><em>The problem is nobody has time to go get it.</em>',
    subtitle: 'Your outstanding accounts receivable is not a write-off. It is revenue you already earned, sitting in claims your team has not had the uninterrupted time to follow through on.',
    description: 'Hired Billing Support works your AR as an active, assigned team — following up on every unpaid claim, communicating with payers daily, and turning a growing aging report into predictable monthly cash flow.',
    card: {
