...
// export default function HeroEndocrinology({ solution }: HeroProps) {
//   return (
...
//                 fontWeight: "600",
//               }}>
//                 — Endocrinology Revenue · Active Claims Dashboard
//               </div>
          ...
          {solution.hero && (
            <>
              ...
              <h1
                ...
                style={{ fontSize: "clamp(38px, 5vw, 64px)", marginTop: "20px" }}
                dangerouslySetInnerHTML={{ __html: solution.hero.title }}
              />

              <p
                className="sub reveal reveal-3"
                style={{ fontSize: "18px", lineHeight: "1.6", color: "var(--ink-mute)", marginTop: "24px" }}
              >
                {solution.hero.subtitle}
              </p>
              ...
              <p
                ...
                style={{ fontSize: "18px", lineHeight: "1.6", color: "var(--ink-mute)", marginTop: "16px" }}
              >
                {solution.hero.description}
              </p>
              ...
              <div className="hero-actions reveal reveal-4" style={{ marginTop: "32px" }}>
                <a href="#cta" className="btn btn-primary btn-lg">
                  Improve endocrinology revenue flow
                  <svg className="arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M5 12h14M13 5l7 7-7 7" />
                  </svg>
                </a>
                ...
                <a href="#solution" className="btn btn-ghost btn-lg">
                  See endocrine billing workflow
                </a>
              </div>
            </>
          )}
        ...
        {solution.hero && (
          <div className="reveal reveal-4" style={{ animationDelay: "0.55s" }}>
            ...
            >
              ...
              >
                — Endocrinology Revenue · Active Care Authorization Dashboard
              </div>

              {/* Care Authorization Rows */}
              {[
                {
                  label: "CGM Authorization — Type 1 Diabetes Patient A",
                  status: "Active — renews in 60 days",
                  type: "approved",
                },
                {
                  label: "Insulin Pump Authorization — Patient B",
                  status: "Renewal due in 12 days",
                  type: "pending",
                },
                {
                  label: "Thyroid Panel Lab Claims — Multiple Patients",
                  status: "3 claims pending review",
                  type: "pending",
                },
                {
                  label: "GLP-1 Therapy Prior Authorization — Patient C",
                  status: "Payer review — Day 11",
                  type: "needed",
                },
                {
                  label: "A1C Follow-Up Care Queue",
                  status: "8 patients scheduled",
                  type: "approved",
                },
              ].map((row, idx) => (
                <div
              ...
              {/* Divider */}
              <div style={{ borderTop: "1px solid var(--paper-line)", margin: "12px 0" }} />
              ...
              >
                {[
                  ...
                  { num: "2", label: "Renew Soon", color: "var(--amber-deep)" },
                  { num: "0", label: "Expired Auths", color: "var(--signal-deep)" },
                ].map((stat, idx) => (
                  <div key={idx} style={{ textAlign: "center" }}>
                    <div
              ...
              >
                ...
                <div style={{ fontSize: "12px", color: "var(--ink-soft)", lineHeight: "1.4" }}>
                  Insulin pump authorization expires in 12 days — renewal request submitted for payer review.
                </div>
              </div>
            </div>
          </div>
