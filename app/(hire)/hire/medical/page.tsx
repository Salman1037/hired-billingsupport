    ...
    <div className="hero-inner">
      <div>
        ...
        <div className="hero-actions reveal reveal-4">
          <a href="#cta" className="btn btn-primary">Book a discovery call <svg className="arrow" width={14} height={14} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
  ...
  <section className="final-cta" id="cta">
    ...
    <div className="cta-inner">
      ...
      <div className="actions">
        <a href="#" className="btn btn-light">Book a discovery call <svg className="arrow" width={14} height={14} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
            <path d="M5 12h14M13 5l7 7-7 7" />
          </svg></a>
        <a href="#" className="btn btn-ghost" style={{color: 'var(--paper)', borderColor: 'rgba(250,247,242,.3)'}}>Request a free
          RCM audit</a>
      </div>
